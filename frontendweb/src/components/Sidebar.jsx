        ...
        <div className="sidebar">
            ...
            <div className="nav-links">
                ...
                <div className={`nav-item ${currentPage === 'dashboard' ? 'active' : ''}`} onClick={onGoHome} title="Home">
                    ...
                    {isAdmin && <span className="nav-label">Home</span>}
                </div>
                ...
                {isAdmin ? (
                    ...
                    <>
                        ...
                        <div className={`nav-item ${currentPage === 'admin_teachers' ? 'active' : ''}`} onClick={onOpenAdminTeachers} title="Teachers">
                        ...
                        <div className={`nav-item ${currentPage === 'admin_students' ? 'active' : ''}`} onClick={onOpenAdminStudents} title="Students">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className={`nav-item ${currentPage === 'admin_courses' ? 'active' : ''}`} onClick={onOpenAdminCourses} title="Courses">
                        ...
                        <div className={`nav-item ${currentPage === 'admin_attendance' ? 'active' : ''}`} onClick={onOpenAdminAttendance} title="Attendance">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className={`nav-item ${currentPage === 'admin_announcements' ? 'active' : ''}`} onClick={onOpenAdminAnnouncements} title="Announcements">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <>
                        ...
                        {!isTeacher && (
                            <>
                                ...
                                <div className={`nav-item ${currentPage === 'badges' ? 'active' : ''}`} onClick={onOpenBadges} title="My Badges">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <circle cx="12" cy="8" r="7"></circle>
                                        <polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>
                                    </svg>
                                </div>
                                <div className={`nav-item ${currentPage === 'leaderboard' ? 'active' : ''}`} onClick={onOpenLeaderboard} title="Leaderboard">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <path d="M6 9H4.5a2.5 2.5 0 010-5H6"></path>
                                        <path d="M18 9h1.5a2.5 2.5 0 000-5H18"></path>
                                        <path d="M4 22h16"></path>
